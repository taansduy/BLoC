...
class ZomatoClient {
  final _apiKey = "e4e3194116b7fef26af748541df63771";
  ...
  Future<List<Restaurant>> fetchRestaurants(Location location,
      String query) async {
    ...
    final restaurants = results['restaurants'].map<Restaurant>((json) =>
        Restaurant.fromJson(json['restaurant'])).toList(growable: false);
    return restaurants;
  }
